...
## Mimari Yapı
Bu proje, monolitik bir REST API uygulamasıdır. Tüm modüller tek bir uygulama içinde çalışır ve aynı veritabanını paylaşır. Modüler yapı, kodun organizasyonu ve bakımı için kullanılmaktadır.
